...
**4.3.1 Plan-and-Solve 的工作原理**：<span style="color: red;">先规划，后执行</span>
...
![Plan-and-Solve工作原理](image/Plan-and-Solve工作原理.png)
...
**4.4.1 Reflection 机制的工作原理**：<span style="color: red;">执行 -> 反思 -> 优化</span>的三步循环
...
![Reflection工作原理](image/Reflection工作原理.png)